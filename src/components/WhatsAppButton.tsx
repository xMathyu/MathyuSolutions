...
const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  const t = useTranslations("LandingPage.Section.WhatsApp");
  ...
  return (
    <div className="fixed bottom-4 right-[88px] sm:bottom-8 sm:right-[112px] z-50">
      ...
      {/* Tooltip */}
      {isHovered && (
        <div className="absolute -left-24 top-1/2 -translate-y-1/2 bg-black text-white text-xs rounded py-1 px-2 whitespace-nowrap">
          {t("Tooltip")}
